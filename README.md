...
The `readme-sync` workflow validates the autogenerated table below on every PR and merge to `master`. Regenerate it with `go run ./cmd/readme-sync --write`.

<!-- BEGIN:SUPPORTED_OPCODES_AUTOGENERATED -->
> This table is auto-generated from `pkg/arkade/opcode.go` by `go run ./cmd/readme-sync --write`.

| Word | Opcode | Hex | Category |
|------|--------|-----|----------|
| OP_CAT | 126 | 0x7e | Data Manipulation |
| OP_SUBSTR | 127 | 0x7f | Data Manipulation |
| OP_LEFT | 128 | 0x80 | Data Manipulation |
| OP_RIGHT | 129 | 0x81 | Data Manipulation |
| OP_INVERT | 131 | 0x83 | Bitwise Logic |
| OP_AND | 132 | 0x84 | Bitwise Logic |
| OP_OR | 133 | 0x85 | Bitwise Logic |
| OP_XOR | 134 | 0x86 | Bitwise Logic |
| OP_2MUL | 141 | 0x8d | Arithmetic |
| OP_2DIV | 142 | 0x8e | Arithmetic |
| OP_MUL | 149 | 0x95 | Arithmetic |
| OP_DIV | 150 | 0x96 | Arithmetic |
| OP_MOD | 151 | 0x97 | Arithmetic |
| OP_LSHIFT | 152 | 0x98 | Arithmetic |
| OP_RSHIFT | 153 | 0x99 | Arithmetic |
| OP_MERKLEBRANCHVERIFY | 179 | 0xb3 | Cryptography |
| OP_SHA256INITIALIZE | 196 | 0xc4 | SHA256 Streaming Operations |
| OP_SHA256UPDATE | 197 | 0xc5 | SHA256 Streaming Operations |
| OP_SHA256FINALIZE | 198 | 0xc6 | SHA256 Streaming Operations |
| OP_INSPECTINPUTOUTPOINT | 199 | 0xc7 | Transaction Introspection (Inputs) |
| OP_INSPECTINPUTARKADESCRIPTHASH | 200 | 0xc8 | Transaction Introspection (Inputs) |
| OP_INSPECTINPUTVALUE | 201 | 0xc9 | Transaction Introspection (Inputs) |
| OP_INSPECTINPUTSCRIPTPUBKEY | 202 | 0xca | Transaction Introspection (Inputs) |
| OP_INSPECTINPUTSEQUENCE | 203 | 0xcb | Transaction Introspection (Inputs) |
| OP_CHECKSIGFROMSTACK | 204 | 0xcc | Cryptography |
| OP_PUSHCURRENTINPUTINDEX | 205 | 0xcd | Transaction Introspection (Inputs) |
| OP_INSPECTINPUTARKADEWITNESSHASH | 206 | 0xce | Transaction Introspection (Inputs) |
| OP_INSPECTOUTPUTVALUE | 207 | 0xcf | Transaction Introspection (Outputs) |
| OP_INSPECTOUTPUTSCRIPTPUBKEY | 209 | 0xd1 | Transaction Introspection (Outputs) |
| OP_INSPECTVERSION | 210 | 0xd2 | Transaction Introspection (Transaction) |
| OP_INSPECTLOCKTIME | 211 | 0xd3 | Transaction Introspection (Transaction) |
| OP_INSPECTNUMINPUTS | 212 | 0xd4 | Transaction Introspection (Transaction) |
| OP_INSPECTNUMOUTPUTS | 213 | 0xd5 | Transaction Introspection (Transaction) |
| OP_TXWEIGHT | 214 | 0xd6 | Transaction Introspection (Transaction) |
| OP_NUM2BIN | 215 | 0xd7 | Arithmetic |
| OP_BIN2NUM | 216 | 0xd8 | Arithmetic |
| OP_ECMULSCALARVERIFY | 227 | 0xe3 | Elliptic Curve Operations |
| OP_TWEAKVERIFY | 228 | 0xe4 | Elliptic Curve Operations |
| OP_INSPECTNUMASSETGROUPS | 229 | 0xe5 | Asset Introspection |
| OP_INSPECTASSETGROUPASSETID | 230 | 0xe6 | Asset Introspection |
| OP_INSPECTASSETGROUPCTRL | 231 | 0xe7 | Asset Introspection |
| OP_FINDASSETGROUPBYASSETID | 232 | 0xe8 | Asset Introspection |
| OP_INSPECTASSETGROUPMETADATAHASH | 233 | 0xe9 | Asset Introspection |
| OP_INSPECTASSETGROUPNUM | 234 | 0xea | Asset Introspection |
| OP_INSPECTASSETGROUP | 235 | 0xeb | Asset Introspection |
| OP_INSPECTASSETGROUPSUM | 236 | 0xec | Asset Introspection |
| OP_INSPECTOUTASSETCOUNT | 237 | 0xed | Asset Introspection |
| OP_INSPECTOUTASSETAT | 238 | 0xee | Asset Introspection |
| OP_INSPECTOUTASSETLOOKUP | 239 | 0xef | Asset Introspection |
| OP_INSPECTINASSETCOUNT | 240 | 0xf0 | Asset Introspection |
| OP_INSPECTINASSETAT | 241 | 0xf1 | Asset Introspection |
| OP_INSPECTINASSETLOOKUP | 242 | 0xf2 | Asset Introspection |
| OP_TXID | 243 | 0xf3 | Transaction Introspection (Transaction) |
| OP_INSPECTPACKET | 244 | 0xf4 | Packet Introspection |
| OP_INSPECTINPUTPACKET | 245 | 0xf5 | Packet Introspection |
<!-- END:SUPPORTED_OPCODES_AUTOGENERATED -->
